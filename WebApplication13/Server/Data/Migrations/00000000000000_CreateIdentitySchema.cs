...
namespace WebApplication13.Server.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutEnd = table.Column<DateTimeOffset>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationTime = table.Column<DateTime>(type: "bigint", nullable: false),
                    Expiration = table.Column<DateTime>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "bigint", nullable: false),
                    Expiration = table.Column<DateTime>(type: "bigint", nullable: true),
                    ConsumedTime = table.Column<DateTime>(type: "bigint", nullable: true),
                    Data = table.Column<string>(type: "text", maxLength: 50000, nullable: false)
                },
                constraints: table =>
                {
